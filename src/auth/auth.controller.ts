import { Controller, Post, Body, Get, Query, Res, Req, UseGuards, UnauthorizedException } from '@nestjs/common';
...
export class AuthController {
    ...
    @Post("Lang")
    @UseGuards(JwtAuthGuard)
    async land(@Req() req: any, @Body() dto: { data: { lang: string } }) {
        console.log("Hi", dto);
        return this.authService.LangGet(req.user.userId, dto.data.lang);
    }
